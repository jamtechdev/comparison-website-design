    ...
    <section className="breadcrumb-section">
      ...
      <section className="blog_post_section py-5">
        <Container>
            <Row>
                <Col md={12}>
                <h2 className="heading-primary secondary">Latest Blog Posts in Electronics</h2>
                </Col>
                <Col md={12}>
                 <BlogSlider/>
                </Col>
                <Col md={12} className="text-center">
                <Button className="view-blog">View All Blog Posts in Electronics <i className="ri-arrow-right-s-line"></i></Button>
