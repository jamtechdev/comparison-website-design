const QuestionIcon = () => {
  return (
    <span className="question_hover_container">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="custom-tool-tip">
        ...
        <div className="display-content">
          <p className="mb-2"><b>What it is:</b> Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
          <p className="mb-2"><b>When it matters:</b> Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
